...
module memory_unit #(
    ...
    localparam _MP_WIDTH_1104140390 = 6'h20;
    localparam _MP_ENTRIES_1104140390 = WORDS;
    logic [((($clog2(_MP_ENTRIES_1104140390)-1) - (0) + 1))-1:0] M_instruction_memory_address;
    ...
    simple_ram #(
        .WIDTH(_MP_WIDTH_1104140390),
        .ENTRIES(_MP_ENTRIES_1104140390)
    ) instruction_memory (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1978475948 = 6'h20;
    localparam _MP_ENTRIES_1978475948 = WORDS;
    logic [((($clog2(_MP_ENTRIES_1978475948)-1) - (0) + 1))-1:0] M_data_memory_waddr;
    logic [31:0] M_data_memory_write_data;
    logic M_data_memory_write_enable;
    logic [((($clog2(_MP_ENTRIES_1978475948)-1) - (0) + 1))-1:0] M_data_memory_raddr;
    logic [31:0] M_data_memory_read_data;
    
    simple_dual_port_ram #(
        .WIDTH(_MP_WIDTH_1978475948),
        .ENTRIES(_MP_ENTRIES_1978475948)
    ) data_memory (
        .wclk(clk),
        .rclk(clk),
