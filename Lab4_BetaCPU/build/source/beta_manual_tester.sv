...
module beta_manual_tester #(
    ...
    localparam _MP_CLK_FREQ_1618952284 = CLK_FREQ;
    localparam _MP_MIN_DELAY_1618952284 = 5'h14;
    localparam _MP_NUM_SYNC_1618952284 = 2'h2;
    logic M_next_button_conditioner_in;
    logic M_next_button_conditioner_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1618952284),
        .MIN_DELAY(_MP_MIN_DELAY_1618952284),
        .NUM_SYNC(_MP_NUM_SYNC_1618952284)
    ...
    localparam _MP_RISE_1196518542 = 1'h1;
    localparam _MP_FALL_1196518542 = 1'h0;
    logic M_next_button_edge_in;
    logic M_next_button_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1196518542),
        .FALL(_MP_FALL_1196518542)
    ) next_button_edge (
        .clk(clk),
    ...
    localparam logic [2:0][31:0] _MP_CLK_FREQ_1653836133 = {2'h3{{(6'h20)'(CLK_FREQ)}}};
    localparam _MP_MIN_DELAY_1653836133 = 5'h14;
    localparam _MP_NUM_SYNC_1653836133 = 2'h2;
    ...
    genvar idx_0_1653836133;
    
    generate
        for (idx_0_1653836133 = 0; idx_0_1653836133 < 3; idx_0_1653836133 = idx_0_1653836133 + 1) begin: forLoop_idx_0_1653836133
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1653836133[idx_0_1653836133]),
                .MIN_DELAY(_MP_MIN_DELAY_1653836133),
                .NUM_SYNC(_MP_NUM_SYNC_1653836133)
            ) interrupt_button_conditioner (
                .clk(M_interrupt_button_conditioner_clk[idx_0_1653836133]),
                .in(M_interrupt_button_conditioner_in[idx_0_1653836133]),
                .out(M_interrupt_button_conditioner_out[idx_0_1653836133])
            );
        end
    endgenerate
    
    
    localparam logic [2:0][0:0] _MP_RISE_289463582 = {{1'h1, 1'h1, 1'h1}};
    localparam logic [2:0][0:0] _MP_FALL_289463582 = {{1'h0, 1'h0, 1'h0}};
    logic [2:0] M_interrupt_button_edge_in;
    logic [2:0] M_interrupt_button_edge_out;
    logic [2:0] M_interrupt_button_edge_clk = {2'h3{clk}};
    
    genvar idx_0_289463582;
    
    generate
        for (idx_0_289463582 = 0; idx_0_289463582 < 3; idx_0_289463582 = idx_0_289463582 + 1) begin: forLoop_idx_0_289463582
            edge_detector #(
                .RISE(_MP_RISE_289463582[idx_0_289463582]),
                .FALL(_MP_FALL_289463582[idx_0_289463582])
            ) interrupt_button_edge (
                .clk(M_interrupt_button_edge_clk[idx_0_289463582]),
                .in(M_interrupt_button_edge_in[idx_0_289463582]),
                .out(M_interrupt_button_edge_out[idx_0_289463582])
            );
        end
    endgenerate
    
    
    localparam _MP_SIZE_1848173783 = 5'h1c;
    localparam _MP_DIV_1848173783 = 1'h0;
    localparam _MP_TOP_1848173783 = 1'h0;
    localparam _MP_UP_1848173783 = 1'h1;
    logic [27:0] M_frequency_divider_value;
    
    counter #(
        .SIZE(_MP_SIZE_1848173783),
        .DIV(_MP_DIV_1848173783),
        .TOP(_MP_TOP_1848173783),
        .UP(_MP_UP_1848173783)
    ) frequency_divider (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_RISE_1206267830 = 1'h1;
    localparam _MP_FALL_1206267830 = 1'h0;
    logic M_slowclock_edge_in;
    logic M_slowclock_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1206267830),
        .FALL(_MP_FALL_1206267830)
    ) slowclock_edge (
        .clk(clk),
    ...
    localparam _MP_RISE_2081283472 = 1'h1;
    localparam _MP_FALL_2081283472 = 1'h0;
    logic M_fastclock_edge_in;
    logic M_fastclock_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_2081283472),
        .FALL(_MP_FALL_2081283472)
    ) fastclock_edge (
        .clk(clk),
    ...
    localparam _MP_DIGITS_888578679 = 3'h4;
    localparam _MP_DIV_888578679 = 5'h10;
    logic [3:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [3:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_888578679),
        .DIV(_MP_DIV_888578679)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
