...
set verilogSources [list "./source/alchitry_top.sv" "./source/reset_conditioner.sv" "./source/alu.sv" "./source/beta_cpu.sv" "./source/beta_manual_tester.sv" "./source/bit_reverse.sv" "./source/boolean.sv" "./source/compare.sv" "./source/control_unit.sv" "./source/instruction_rom.sv" "./source/memory_unit.sv" "./source/motherboard.sv" "./source/multi_seven_seg.sv" "./source/multiplier.sv" "./source/mux_2.sv" "./source/mux_4.sv" "./source/pc_unit.sv" "./source/regfile_memory.sv" "./source/regfile_unit.sv" "./source/seven_seg.sv" "./source/shifter.sv" "./source/pipeline.sv" "./source/button_conditioner.sv" "./source/counter.sv" "./source/decoder.sv" "./source/edge_detector.sv" "./source/simple_ram.v.sv" "./source/simple_dual_port_ram.v.sv" "./source/adder_32b.sv" "./source/cl_4b_adder.sv" "./source/partial_cl_adder.sv" "./source/lucid_globals.sv" ]
